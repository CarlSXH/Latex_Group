...
\par First we recall some facts we need about complex K-theory. Thishas a geometric interpretation; a complex vector-bundle $\xi$ over $X$ represents an element of $K^0(X)$. (See section~\plscite{6}.) Similarly, a formal linear combination of bundles, such as $\xi-\eta$, gives an element of $K^0(X)$. The Whitney sum of bundles gives addition in $K^0(X)$;  the tensor product of bundles gives multiplication in $K^0(X)$.
