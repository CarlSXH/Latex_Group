...
\newcommand{\lar}[1]{\overset{#1}{\longrightarrow}} %shorthand for longrightarrow with something set above it
...
\newcommand{\te}[1]{\mathop{\mathrm{#1}}} %for functions with like, text names. for example do \te{Cyl}(X)
...
%commutative triangle, 1,2,3 are upper left, right and down respectively, and 4,5,6 are left to right arrow, right to down and left to down arrow overset respectively
