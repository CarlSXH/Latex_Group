...
Example (i). Let $X=S$. Initially most people need to compute stable homotopy, that is, $[S, Y]_\ast$. Of course $E_\ast(S)$ is projective over $\pi_\ast(E)$ for any ring-spectrum E; in fact it is free on one generator. %pog wtf?
