...
and
$$\Tor_1^R\left(F,\prod_\alpha G_\alpha\right) \lar{} \prod_\alpha \Tor_1^R(F,G_\alpha) $$ %to be fixed later
Are isomorphisms
\end{customlemma}
\begin{proof}
...
\begin{tikzcd}
	0 & {\Tor_1^R\left(F,\displaystyle \prod_\alpha G_\alpha\right) } & {\left(\displaystyle\sum_1^n R \right)\otimes \displaystyle\prod_\alpha G_\alpha} && {\left(\displaystyle\sum_1^m R \right)\otimes \displaystyle\prod_\alpha G_\alpha} & {F\otimes \displaystyle\prod_\alpha G_\alpha} & 0 \\
	...
	0 & {\displaystyle \prod_\alpha\Tor_1^R\left(F, G_\alpha\right) } & {\displaystyle \prod_\alpha \left(\left(\sum_1^n R\right)\otimes G_\alpha\right)} && {\displaystyle \prod_\alpha \left(\left(\sum_1^m R\right)\otimes G_\alpha\right)} & {\displaystyle \prod_\alpha(F\otimes G_\alpha)} & 0
...
\adjustbox{scale=0.8,center}{
\begin{tikzcd}
	0 & {H_n(E;R)\otimes_R\displaystyle\prod_\alpha G_\alpha} & {H_n\left(E;\displaystyle\prod_\alpha G_\alpha\right)} & {\Tor_1^R\left(H_{n-1}(E;R);\displaystyle\prod_\alpha G_\alpha\right)} & 0 \\
	0 & {\displaystyle\prod_\alpha H_n(E;R)\otimes_R G_\alpha} & {\displaystyle\prod_\alpha H_n(E;G_\alpha)} & {\displaystyle\prod_\alpha \Tor_1^R\left(H_{n-1}(E;R);\displaystyle G_\alpha\right)} & 0
