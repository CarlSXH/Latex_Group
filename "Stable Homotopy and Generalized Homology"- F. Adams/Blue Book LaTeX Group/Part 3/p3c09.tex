...
\begin{tikzcd}
{E_p(A) \otimes F_q(Y, B)} \arrow[dd] \arrow[r, "\underline X"]                          & {(E \wedge F)_{p + q}(A \times Y, A \times B)} \arrow[rd, "\cong"]                     &                                                                            \\
                                                                                         &                                                                                        & {(E \wedge F)_{p + q} (A \times Y \cup X \times B, X \times B)} \arrow[ld] \\
{E_p(X) \otimes F_q(Y, B)} \arrow[d] \arrow[r, "\underline X"]                           & {(E \wedge F)_{p + q}(X \times Y, X \times B)} \arrow[d]                               &                                                                            \\
{E_p(X, A) \otimes F_q(Y, B)} \arrow[r, "\underline X"] \arrow[dd, "\partial \otimes 1"] & {(E \wedge F)_{p + q} (X \times Y, A \times Y \cup X \times B)} \arrow[rd, "\partial"] &                                                                            \\
                                                                                         &                                                                                        & {(E \wedge F)_{p + q - 1} (A \times Y \cup X \times B, X \times B)}        \\
{E_{p - 1}(A) \otimes F_q(Y, B)} \arrow[r, "\underline X"]                               & {(E \wedge F)_{p + q - 1}(A \times Y, A \times B)} \arrow[ru, "\cong"']                &                                                                           
\end{tikzcd}
}
...
& & {\frac{X}{A}} \wedge \frac{Y}{B} \arrow[uu,"\cong"] \arrow[r,"i \wedge j'"] & {\frac{X}{B} \wedge B}  \arrow[u,"\cong"]
\end{tikzcd}
\end{center}
\end{lemma}
...
\par We now get the following eight commutative diagrams by applying Proposition \plscite{3.1} to the diagrams in Lemma~\ref{lem:p3c09.9}. The morphisms $J, j$ and sign conventions are as above.
...
\begin{tikzcd}
{E^p(\frac{A\wedge Y \cup X \wedge B}{X \wedge B}) \otimes F_q{Y \choose B}} \arrow[d,"\cong \otimes 1"] \arrow[r,"J^\ast \otimes 1"] & {E^{p+1}(\frac{X\wedge Y}{A \wedge Y \cup X \wedge B}) \otimes F_q(\frac{Y}{B})} \arrow[d,equals] \\
...
{H_{p - 1}(A) \otimes H_q(Y, B)} \arrow[dd, "\underline X"'] &                                                                                                  & {H_p(X, A) \otimes H_{q - 1}(B)} \arrow[dd, "\underline X"] \\
                                                             & (-1)                                                                                             &                                                             \\
...
\begin{tikzcd}
                                                                                             & {E^p(X, A) \otimes F^q(Y, B)} \arrow[ld, "\partial \otimes 1"', dashed] \arrow[rd, "1 \otimes \partial", dashed] \arrow[dd, "\underline X"] &                                                                                    \\
{E_{p - 1}(A) \otimes E_q(Y, B)} \arrow[dddd, "\underline X"', dashed, bend right=81.5]           &                                                                                                                                             & {E_p(X, A) \otimes F_{q - 1}(B)} \arrow[dddd, "\underline X", dotted, bend left=81.5]    \\
...
The diagram displays $$(E \wedge F)_{p + q - 1} (A \times Y \cup X \times B, A \times B)$$ as the direct sum $$(E \wedge F)_{p + q - 1} (A \times Y, A \times B) \oplus (E \wedge F)_{p + q - 1} (X \times B, A \times B).$$ The composite $i_\ast \partial_1$ is zero, so the two paths from $(E \wedge F)_{p + q}(X \times Y, A \times Y \cup X \times B)$ around the outside of the lower hexagon gives maps whose sum is zero. This is the Eilenberg-Steenrod hexagon lemma. Of course, we know the result geometrically by \plscite{6.9}. Now fill in the rest of the diagram by \ref{thm:p3c09.11}. 
...
{E^{p + 1}(X, A) \otimes F^q(B)} \arrow[d, "\overline X"]                                        &                                                                                      & E^p(A)\otimes F^{q + 1}(B) \arrow[d, "\overline X"]                                               \\
...
{E_{p - 1}(A) \otimes F_q(Y, B)} \arrow[dd, "\underline X"']  &                                                                                                  & {E_p(X, A) \otimes F_{q - 1}(B)} \arrow[dd, "\underline X"]   \\
                                                              & (-1)                                                                                             &                                                               \\
