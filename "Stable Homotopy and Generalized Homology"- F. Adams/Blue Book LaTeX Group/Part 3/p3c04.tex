...
%insert another big diagram here lol
...
This completes the proof of Lemma~\ref{lem:p3c04.7}, which completes the proof of \plscite{4.3}, which completes the proof of Theorem~\ref{thm:p3c04.1} so far as it refers to maps of degree $0$. 
\end{proof}
